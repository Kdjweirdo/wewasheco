...
class TableausControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tableau" do
    assert_difference('Tableau.count') do
      post tableaus_url, params: { tableau: { email: @tableau.email, entreprise: @tableau.entreprise, nom: @tableau.nom, numero: @tableau.numero, string: @tableau.string } }
    end
  ...
  test "should update tableau" do
    patch tableau_url(@tableau), params: { tableau: { email: @tableau.email, entreprise: @tableau.entreprise, nom: @tableau.nom, numero: @tableau.numero, string: @tableau.string } }
